...
## Objective:
- To introduce you to the basics of Python programming.
- To enable you to write simple Python programs.
...
- **Installing Python:** Download and install Python from the official website (python.org).
- **Introduction to Python IDEs:** Demonstrate how to use IDLE, PyCharm, or VS Code for writing Python code.
- **Hands-on Activity:** Install Python and set up their development environment.
...
- **Hands-on Activity:** Write and run their own "Hello, World!" program.
...
- **Hands-on Activity:** Practice writing properly indented code and adding comments.
...
- **Hands-on Activity:** Declare and initialize variables.
...
- **Hands-on Activity:** Practice naming variables.
...
- **Hands-on Activity:** Create variables with different data types.
...
- **Hands-on Activity:** Perform operations on string variables.
...
- **Examples:**
  ...
  - `print("Hello, " + name)`
- **Hands-on Activity:** Write programs that take user input and display the output.
